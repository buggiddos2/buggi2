...
ALLOWED_GROUP_IDS = [-1002566362589]
MAX_THREADS = 1000
max_duration = 120
bot_open = False
OWNER_USERNAME = "buggi_3"
SPECIAL_MAX_DURATION = 600
SPECIAL_MAX_THREADS = 2000
BOT_START_TIME = time.time()

ACTIVE_VPS_COUNT = 10  # डिफॉल्ट रूप से 6 VPS इस्तेमाल होंगे
...
async def rules(update: Update, context: CallbackContext):
    ...
    rules_text = (
        ...
        "JO GAND DEGA USSE EXTRA KEY DUNGA.\n\n"
    )
